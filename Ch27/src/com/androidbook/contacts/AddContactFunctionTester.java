...
public class AddContactFunctionTester extends ContactDataFunctionTester 
{
	...
	{
		return insertRawContactWithAKnownAccount();
		//return testInsertRawContactWithoutAccount();
	}
	private long insertRawContactWithAKnownAccount()
	{
		ContentValues cv = new ContentValues();
		//Use your corresponding account
	...
	private long testInsertRawContactWithoutAccount()
	{
		ContentValues cv = new ContentValues();
		Uri rawContactUri = 
			this.mContext.getContentResolver()
